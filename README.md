...
`README.md` digunakan untuk dokumentasi fitur dan penggunaan, sedangkan `CHANGELOG.md` khusus untuk riwayat perubahan versi.
...
```javascript
console.log(InteractiveGrid.VERSION); // 2.9.2
```
...
Seluruh riwayat versi dan perubahan plugin dipindahkan ke file **`CHANGELOG.md`**. Mulai versi 2.9.2, setiap perubahan berikutnya harus dicatat di file tersebut dan tidak lagi ditambahkan sebagai daftar changelog di README.
